...
\titleformat{\section}
  ...
  {\thesection}{1em}{}\titlespacing*{\section}{-42pt}{-2pt}{-12pt}
\titleformat{\subsection}
  {\normalfont\sffamily\large\bfseries\color{black}}
  {\thesubsection}{1em}{}\titlespacing*{\subsection}{-48pt}{2pt}{-12pt}
  %{\thesection}{1em}{}
...
{\sffamily
\newgeometry{left=3.6cm,right=3.6cm,top=3.6cm,bottom=2.7cm}
\begin{titlepage}
{
...
\newgeometry{left=3.7cm,right=3.7cm,top=3.7cm,bottom=4.2cm}
\pagestyle{fancy}
\fancyhead{}
\fancyhead[R]{\today}
\fancyhead[L]{Title - Subtitle\\Name Surname}
